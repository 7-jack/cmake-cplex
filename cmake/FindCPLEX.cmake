...
# Modification:
# - The original source only focused in Windows, so hints was needed in *NIX distributions.
...
message("cplex root dir: ${CPLEX_ROOT_DIR}")
...
message("cplex include dir: ${CPLEX_INCLUDE_DIR}")
...
message("concert include dir: ${CPLEX_CONCERT_INCLUDE_DIR}")
...
message("cpoptimizer include dir: ${CPLEX_CPOPTIMIZER_INCLUDE_DIR}")
...
FIND_LIBRARY(CPLEX_LIBRARY
    ...
    ${CPLEX_ROOT_DIR}/cplex/lib/arm64_osx/static_pic # ARM64 baby
...
FIND_LIBRARY(CPLEX_CONCERT_LIBRARY
    ...
    ${CPLEX_ROOT_DIR}/concert/lib/arm64_osx/static_pic # ARM64 baby
    PATHS ENV LIBRARY_PATH
    ENV LD_LIBRARY_PATH
)
...
FIND_LIBRARY(CPLEX_CPOPTIMIZER_LIBRARY
    ...
    ${CPLEX_ROOT_DIR}/cpoptimizer/lib/arm64_osx/static_pic # ARM64 baby
    PATHS ENV LIBRARY_PATH
    ENV LD_LIBRARY_PATH
)
...
if(WIN32)
    ...
    FIND_PATH(CPLEX_BIN_DIR
        ...
        ${CPLEX_ROOT_DIR}/cplex/bin/arm64_osx # ARM64 baby
        ENV LIBRARY_PATH
        ENV LD_LIBRARY_PATH
    )
endif()
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(CPLEX DEFAULT_MSG
    ...
    CPLEX_CONCERT_LIBRARY CPLEX_CONCERT_INCLUDE_DIR
    CPLEX_CPOPTIMIZER_LIBRARY CPLEX_CPOPTIMIZER_INCLUDE_DIR)

IF(CPLEX_FOUND)
    SET(CPLEX_INCLUDE_DIRS ${CPLEX_INCLUDE_DIR} ${CPLEX_CONCERT_INCLUDE_DIR} ${CPLEX_CPOPTIMIZER_INCLUDE_DIR})
    SET(CPLEX_LIBRARIES ${CPLEX_CONCERT_LIBRARY} ${CPLEX_ILOCPLEX_LIBRARY} ${CPLEX_LIBRARY} ${CPLEX_CPOPTIMIZER_LIBRARY})
...
MESSAGE(STATUS "CPLEX LIBRARIES: ${CPLEX_LIBRARIES}")

MARK_AS_ADVANCED(
    CPLEX_LIBRARY CPLEX_INCLUDE_DIR 
    CPLEX_ILOCPLEX_LIBRARY 
    CPLEX_CONCERT_INCLUDE_DIR CPLEX_CONCERT_LIBRARY
    CPLEX_CPOPTIMIZER_LIBRARY CPLEX_CPOPTIMIZER_INCLUDE_DIR)
